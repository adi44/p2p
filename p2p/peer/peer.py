...
class query_indexer():
    def __init__(self):
        self.ci_server_host = '10.1.80.113'
    ...
    def obtain(self,peer_id,file_name):
        ...
        try:
            server_addr = ('10.1.80.113',int(peer_id))
...
if __name__ == '__main__':
    ...
    print 'Both Central Server and Peer are running on : 10.1.80.113'    
